...
const ERROR_MESSAGES: Record<string, string> = {
  invalido: "E-mail ou senha invÃ¡lidos.",
  bloqueado: "Este usuÃ¡rio estÃ¡ bloqueado. Fale com um administrador.",
  inativo: "Este usuÃ¡rio estÃ¡ inativo. Fale com um administrador.",
  sem_senha: "sem_senha", // tratado Ã  parte (mostra link para cadastro de senha)
};
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (res?.error) {
      if (res.error === "sem_senha") {
        ...
        setError(ERROR_MESSAGES[res.error] ?? "NÃ£o foi possÃ­vel entrar. Tente novamente.");
      }
      return;
    }
    router.push("/inicio");
        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-4">
          ...
          {needsPassword ? (
            <p className="text-sm text-yellow-700">
              Este Ã© seu primeiro acesso â€” ainda nÃ£o hÃ¡ senha cadastrada.{" "}
