...
type Project = { id: string; name: string; lead?: { companyName: string } | null };
type Inconsistency = {
...
export default function AuditoriaPage() {
  ...
  const filtered = useMemo(() => items.filter(i => {
    ...
    const matchesQ = !q || [i.code, i.description, i.project?.name ?? "", i.project?.lead?.companyName ?? ""].join(" ").toLowerCase().includes(q);
